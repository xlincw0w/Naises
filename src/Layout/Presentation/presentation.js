    ...
    render() {
        return (
            <div className="mt5" style={{ 'width': '100%', 'height': '900px' }}>
                <div className="tc">
                    <p className="black-70" style={{ 'fontSize': '2rem' }}>Pourquoi Naises</p>
                    <p className="center black-60 f5" style={{ 'width': '30%' }}>
                    ...
                    <div className="center">
                        <div className="dib spaceHorizontal tc">
                            <div className="center" style={{ 'width': '150px', 'height': '150px' }}>
                                <img src={connect} role='image' alt='Connection' />
                            </div>
                            <div>
                                <p className="f5 black-60 mt4" style={{ 'width': '250px', 'height': '500px' }}>
                        ...
                        <div className="dib spaceHorizontal tc">
                            <div className="center" style={{ 'width': '150px', 'height': '150px' }}>
                                <img src={book} role='image' alt='Book' />
                            </div>
                            <div>
                                <p className="f5 black-60 mt4" style={{ 'width': '250px', 'height': '500px' }}>
                        ...
                        <div className="dib spaceHorizontal tc">
                            <div className="center" style={{ 'width': '150px', 'height': '150px' }}>
                                <img src={update} role='image' alt='Stay updated' />
                            </div>
                            <div>
                                <p className="f5 black-60 mt4" style={{ 'width': '250px', 'height': '500px' }}>
                ...
                <div className="tc">
                    <p className="black-70 mt4" style={{ 'fontSize': '2rem' }}>Nous contacter ?</p>
                    <p className="center black-60 f5" style={{ 'width': '30%' }}>
                        Vous ne trouvez pas la réponse à votre question,
                        le support Naises est à votre disposition
                    </p>
                    <div className="mtopqueries">
                        <Link to="/contact" className="NaisesButton br3 grow shadow-4">Cliquez ici</Link>
                    </div>
                </div>
